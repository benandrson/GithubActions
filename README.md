[![Run App Benjamin Anderson](https://github.com/benandrson/GithubActions/actions/workflows/run-app.yaml/badge.svg)](https://github.com/benandrson/GithubActions/actions/workflows/run-app.yaml)
